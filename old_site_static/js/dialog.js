/* EveKit Module */
(function() {
var eveKitDialog = angular.module('eveKitDialog', ['ngSanitize']);
...
eveKitDialog.controller('EveKitDialogCtrl', ['$scope', '$timeout', '$sce',
 ...
 */
eveKitDialog.factory('DialogService', 
    ['$rootScope', 
     function($rootScope) {
      var itemID = 1;
      return {
